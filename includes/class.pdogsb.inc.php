...
class PdoGsb
{
    ...
    /**
     * Cloture les fiches de frais du mois précdent si celles-ci sont en cours
     *
     * @param String $moisPrecedent mois précdent à cloturer
     *
     */
    public function clotureFichesFrais($moisPrecedent)
    {
        $requetePrepare = PdoGsb::$monPdo->prepare(
            'UPDATE fichefrais'
