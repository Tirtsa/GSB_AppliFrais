...
/**
 * Teste si un  quelconque visiteur médical est connecté
 *
 * @return vrai ou faux
 */
 ...
 *
 * @param String îdUtilisateur ID de l'utilisateur
...
/**
 * Fonction qui retourne les 12 derniers mois par rapport à un mois donné
 *
 * @param String $mois Contient le mois actuel
 *
 * @return Array les 12 mois d'avant
 */
